...
class ViewController: UITableViewController {
    ...
    func submit(_ answer: String){
        ...
        if answer.count > 2 {
            if isPossible(word: lowerAnswer) {
                if isOriginal(word: lowerAnswer) {
                    if isReal(word: lowerAnswer) {
                        ...
                        errorMessage = "You can't just make any word!"
                    }
                }else{
                    errorTitle = "Word Already Used"
                    errorMessage = "This word was already used in previous input!"
                }
            }else{
            ...
            errorTitle = "Short Word Count"
            errorMessage = "Words must contain atleast 3 letters!"
        }
